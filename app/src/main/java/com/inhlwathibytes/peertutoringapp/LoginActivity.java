...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView termsLink = findViewById(R.id.textViewTerms);
        TextView privacyLink = findViewById(R.id.textViewPrivacy);
    ...
    private boolean validateStudentLogin(String email, String password) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            String phone = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.STUDENT_PHONE));

            // Save session
            sessionManager.createLoginSession(id, name, email, phone, "student");
    ...
    private boolean validateTutorLogin(String email, String password) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            // Save session
            sessionManager.createLoginSession(id, name, email, phone, "tutor");
